...
represent([rpb(X), Wr, Wo], inheritance(product([X, Co]), Cr), V) :- represent([Ws], Cs, V1), represent([Ws, Wr, Wo], inheritance(product([Cs, Co]), Cr), V2), f_ind(V1, V2, V). 
represent([Ws, Wr, rpb(X)], inheritance(product([Cs, X]), Cr), V) :- represent([Wo], Co, V1), represent([Ws, Wr, Wo], inheritance(product([Cs, Co]), Cr), V2), f_ind(V1, V2, V). 
